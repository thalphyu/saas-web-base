...
export class GadgetInstanceService {
    ...
    addInstance(gadget: any) {
        ...
        //     }
        // }
        for (const x of this.concreteGadgetInstances) {
            if (gadget.instance.instanceId === x.instance.instanceId) {
                gadgetFound = true;
            }
        }
    ...
    enableConfigureMode() {
        ...
        this.concreteGadgetInstances.forEach((gadget) =>{
    ...
    removeInstance(id: number) {
        ...
        for (let x = this.concreteGadgetInstances.length - 1; x >= 0; x--) {
            ...
            if (this.concreteGadgetInstances[x].instance.instanceId === id) {
                ...
                const gadget = this.concreteGadgetInstances.splice(x, 1);
